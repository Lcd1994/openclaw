      ...
      <div class="list" style="margin-top: 16px;">
        ${
          props.nodes.length === 0
            ? html`
                <div class="muted">${t("nodes.notFound")}</div>
              `
        ...
        !state.ready
          ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.configLoading} @click=${state.onLoadConfig}>
              ${state.configLoading ? t("nodes.loadingConfig") : t("nodes.loadConfigBtn")}
            </button>
          </div>`
          : html`
            <div class="list" style="margin-top: 16px;">
        ...
        !ready
          ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.loading || !targetReady} @click=${state.onLoad}>
              ${state.loading ? t("nodes.loadingApprovals") : t("nodes.loadApprovalsBtn")}
            </button>
          </div>`
          : html`
    ...
    <div class="list" style="margin-top: 12px;">
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`
              <div class="muted">${t("nodes.noExecApprovals")}</div>
            `
          : nothing
      }
    </div>
    ...
    <div class="list" style="margin-top: 16px;">
            ...
            >
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${t("nodes.useDefault")} (${defaults.security})
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
                (option) =>
                  ...
                  >
                    ${option.value === "deny" ? t("nodes.deny") : option.value === "allowlist" ? t("nodes.allowlist") : option.value === "full" ? t("nodes.full") : option.label}
                  </option>`,
              )}
            </select>
          </label>
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.askDefault") : `${t("nodes.defaultPromptValue")}: ${defaults.ask}.`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${t("nodes.useDefault")} (${defaults.ask})
                  </option>`
                  : nothing
              }
              ${ASK_OPTIONS.map(
                (option) =>
                  ...
                  >
                    ${option.value === "off" ? t("nodes.off") : option.value === "on-miss" ? t("nodes.onMiss") : option.value === "always" ? t("nodes.always") : option.label}
                  </option>`,
              )}
            </select>
          </label>
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.askFallbackUnavailable")
                : `${t("nodes.defaultSecurityValue")}: ${defaults.askFallback}.`
            }
          </div>
        </div>
        <div class="list-meta">
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${t("nodes.useDefault")} (${defaults.askFallback})
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${
              isDefaults
                ? t("nodes.autoAllowSkillClisSub")
                : autoIsDefault
                  ? `${t("nodes.usingDefault")} (${defaults.autoAllowSkills ? t("nodes.on") : t("nodes.off")}).`
                  : `${t("nodes.override")} (${autoEffective ? t("nodes.on") : t("nodes.off")}).`
            }
          </div>
        </div>
        <div class="list-meta">
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`
              <div class="muted">${t("nodes.noAllowlist")}</div>
            `
