      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">openclaw dashboard --no-open</span> → ${t("overview.authRequiredTip1")}<br />
            <span class="mono">openclaw doctor --generate-gateway-token</span> → ${t("overview.authRequiredTip2")}
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
  ...
  return html`
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="note-grid" style="margin-top: 14px;">
        ...
        <div>
          <div class="note-title">${t("overview.noteSession")}</div>
          <div class="muted">${t("overview.noteSessionSub")}</div>
        </div>
        <div>
