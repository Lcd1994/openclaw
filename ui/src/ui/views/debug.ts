            ...
            ${
              securitySummary
                ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  ${t("debug.securityAudit")}: ${securityLabel}${info > 0 ? ` · ${info} ${t("debug.info")}` : ""}. ${t("debug.runCommand")}
                  <span class="mono">openclaw security audit --deep</span> ${t("debug.runCommandDetails")}
                </div>`
                : nothing
            }
        ...
        <div class="form-grid" style="margin-top: 16px;">
          <label class="field">
            ...
            <input
              ...
              placeholder="${t("debug.placeholderMethod")}"
            />
          </label>
          <label class="field">
